 ...
 */
public class SeekController2 extends Controller {
    ...
    public SeekController2(GameObject _target){
        target = _target;
        firstUpdate = true;
    ...
    public void update(Car subject, Game game, double delta_t, double[] controlVariables) {
        ...
        double angularAccel = getAngularAccel(accelRequest, currentVelocity);
        ...
        // Steering Left/Right
        if (angularAccel > 0.01){
            controlVariables[VARIABLE_STEERING] = 1;
        }
        else if (angularAccel < 0.01){
            controlVariables[VARIABLE_STEERING] = -1;
        }
    ...
    private double getAngularAccel(GameVector accelRequest, GameVector dirVector){
        ...
        GameVector right = new GameVector(dirVector.getX(), dirVector.getY() * -1);
